...
console.log(total);
var total = getSum(20,30);
console.log(total);
var total = getSum(8,16);
console.log(total);
var total = getSum(8,8);
console.log(total);
var total = getSum(1,9);
console.log(total);
var total = getSum(9,1);
console.log(total);
var total = getSum(0,2);
console.log(total);
var total = getSum(2,0);
console.log(total);
var total = getSum(-2,-3);
console.log(total);
var total = getSum(-20,20);
console.log(total);
